      ...
      <div className="container">
        <div className="footer__top">
          ...
          <div className="footer__col">
            ...
            <a href={`https://wa.me/${company.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noreferrer">WhatsApp</a>
            <span style={{ display: 'block', color: 'rgba(244,243,239,0.5)', padding: '0.4rem 0', fontSize: '0.95rem' }}>{company.location}</span>
          </div>
        </div>

        <div className="footer__bottom">
          <span>© {year} 24K Media. We Build Internet Brands.</span>
          <span>Crafted to a higher bar — premium by default.</span>
        </div>
      </div>
    </footer>
  )
