...
// Leadership first, then the video-editing pod.
export const team = [
  { id: 'tm1', name: 'Ankit Yadav', role: 'Co-founder', accent: 'purple', bio: 'IIT Roorkee alumnus who has built platforms from a hostel room into products people rely on. Sets the studio’s vision, positioning and growth direction.', socials: {}, image: 'team/ankit-yadav.png', imgPos: 'center 20%' },
  { id: 'tm2', name: 'Ankit Kumar', role: 'CTO & Web/AI Analytics Head', accent: 'blue', bio: 'As the CTO of 24K Media, I lead the technology strategy behind our content creation and channel management ecosystem. From AI-powered workflows to scalable digital solutions, I focus on helping creators and brands grow, innovate, and maximize their online impact.', socials: {}, image: 'team/ankit-kumar.png' },
  { id: 'tm7', name: 'K. Gopal', role: 'Operations Head', accent: 'green', bio: 'Runs day-to-day operations — onboarding, delivery and the studio’s production rhythm. Keeps every brand’s work shipping on schedule.', socials: {}, image: 'team/gopal.png', imgPos: 'center top' },
